...
const DEFAULT_FAQ = [
  { q: 'Is this site affiliated with the club?',           a: 'No. La Quinta Golf Lifestyle is an independent guide. We have no formal affiliation with any private club referenced on the site.' },
  { q: 'Can you list a home in this community for me?',    a: 'No. We do not list, broker, or sell real estate. A live IDX listings feed will appear on the site only when a verified California CARETS/CRMLS feed and a licensed-agent partner are in place.' },
];
