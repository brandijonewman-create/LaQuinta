...
export const site = {
  ...
  // Canonical site URL. Read from NEXT_PUBLIC_BASE_URL at build/runtime so the
  // preview and production environments each emit correct canonical/OG/JSON-LD
  // URLs. Fallback to the production domain only if env var is unset.
  ...
  description:
    'Independent coverage of golf real estate, private clubs, and the desert lifestyle of La Quinta, California — home to PGA West, The Madison Club, The Hideaway, Andalusia, The Tradition, The Quarry, and La Quinta Country Club.',
  // PLACEHOLDER — owner has not yet provided a real address.
