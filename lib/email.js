...
export async function sendQuizLeadConfirmationEmail({ name, email, matchedCommunity, downloadUrl, baseUrl }) {
  ...
  const inner = `
    ...
    <p style="font-size:14px;line-height:1.65;margin-top:24px;">A few honest notes: this site is an independent guide, not a brokerage. The matched community is a starting point, not a recommendation to transact. A member of our team may reach out directly. There are no automated marketing emails.</p>
