...
function shellHtml(inner) {
  ...
  <div style="max-width:600px;margin:0 auto;padding:32px 24px;">
    ...
    <div style="margin-top:32px;padding-top:18px;border-top:1px solid #D8CCB0;font-size:11px;color:#7A6E60;font-family:Arial,sans-serif;line-height:1.5;">
      ${SITE} is an independent guide. We do not list, broker, or sell real estate. Estimate only — verify with a licensed California real-estate professional before transacting.
    </div>
  </div></body></html>`;
}
...
export async function sendQuizLeadConfirmationEmail({ name, email, matchedCommunity, downloadUrl, baseUrl }) {
  ...
  const inner = `
    ...
    <p style="font-size:14px;line-height:1.65;margin-top:24px;">A few honest notes: this site is an independent guide, not a brokerage. The matched community is a starting point, not a recommendation to transact. Brandi may reach out directly. There are no automated marketing emails.</p>
    <p style="font-size:14px;line-height:1.65;margin-top:18px;">— Brandi Jo Newman, owner and creator</p>`;
  try {
