...
export const collaborators = [
  ...
  {
    slug: 'kathy-schowe',
    page: 'california-lifestyles',
    anchor: 'kathy-schowe',
    name: 'Kathy Schowe',
    jobTitle: 'Real Estate Professional',
    affiliation: 'California Lifestyles',
    bio: 'Kathy Schowe specializes in private-club real estate inside La Quinta\u2019s gated golf communities, with a particular focus on La Quinta Country Club, PGA West, and the historic Cove. Her listings emphasize the indoor-outdoor architecture and fairway-and-mountain settings that define the desert lifestyle.',
    headshot: null,
  },
];
