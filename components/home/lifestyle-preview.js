...
const pillars = [
  {
    ...
    title: 'Pete Dye, Tom Fazio, Tom Doak, and the routings that shaped the valley.',
    href: '/architects',
    image: 'https://images.pexels.com/photos/8334036/pexels-photo-8334036.jpeg',
  },
  {
    eyebrow: 'The Map',
    title: 'An interactive lifestyle map — clubs, neighborhoods, hiking, and El Paseo.',
    href: '/desert-lifestyle-map',
    image: 'https://images.unsplash.com/photo-1621881806763-1b8128f374a7',
  },
  {
    eyebrow: 'The Guides',
    title: 'Long-form pillar pieces — starting with the 2026 Desert Buyer’s Guide.',
    href: '/guides',
    ...
    <section className="container py-24 lg:py-32">
      <div className="max-w-2xl mb-14">
        ...
        <p className="text-foreground/70 mt-5 text-base md:text-lg leading-relaxed">
          The desert is a story about water, design, and a winter sun that built a
        ...
        {pillars.map((p) => (
          ...
          >
            ...
            <div className="absolute inset-0 p-7 lg:p-8 flex flex-col justify-end text-white">
              ...
              <div className="font-serif text-2xl lg:text-[26px] leading-[1.2]">
                {p.title}
              </div>
