...
// Placeholder cards for Phase 1. The real MDX-driven Journal index ships in Phase 2.
const placeholders = [
  {
    title: 'Inside The Madison Club: Why La Quinta’s most private address stays private',
  ...
  {
    title: 'Tom Doak’s Stone Eagle and the case for minimalism in the desert',
      ...
      <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-14">
        <div className="max-w-2xl">
          ...
          <p className="text-foreground/70 mt-5 text-base md:text-lg leading-relaxed">
            Long-form editorial — community deep-dives, architect profiles, and
            honest market commentary. Launch issue lands in Phase 5.
          </p>
        </div>
      </div>
