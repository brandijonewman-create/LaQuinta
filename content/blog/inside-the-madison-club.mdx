...
What we will tell you, confidently: Madison is an editorial story about architectural restraint, about a small private-club model that has held up while many larger ones have churned, and about the part of La Quinta that goes quietest in the summer and busiest in March. Whether that matches what you want from a desert second home is a question only you can answer.
